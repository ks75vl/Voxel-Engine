...
public class PlayerInventory : MonoBehaviour
{
    ...
    Text hungerText;
    Image hungerImage;
    float hungerCountTime = 0;
    public float hungerIntervalTime = 3;
    public int hungerInterval = 1;
    ...
    void Start()
    {
        if (HPMANACanvas != null)
        {
            ...
            //
            hungerText = HPMANACanvas.transform.GetChild(3).GetChild(0).GetComponent<Text>();
            ...
            hungerImage = HPMANACanvas.transform.GetChild(3).GetComponent<Image>();
    ...
    void Update()
    {
        ...
        //Hunger down
        if (hungerCountTime > hungerIntervalTime)
        {
            hungerCountTime = 0;
            currentHunger -= hungerInterval;
            UpdateHungerBar();
        }
